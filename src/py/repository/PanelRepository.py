...
class PanelRepository(RepositoryBase[Panel]):
    ...
    def create_table(self) -> None:
        query = 'CREATE TABLE IF NOT EXISTS Panel ("ID" INTEGER,"PanelNameID" INTEGER,"Time" TEXT,"Value" INTEGER,PRIMARY KEY("ID"),FOREIGN KEY("PanelNameID") REFERENCES "PanelName"("ID"));'
    ...
    def get_all_entities(self) -> list[Panel]:
        ...
        for result in results:
            found_panels.append(SQLMapper.map_row_to_panel(result))
